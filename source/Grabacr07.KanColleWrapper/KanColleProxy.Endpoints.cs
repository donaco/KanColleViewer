...
namespace Grabacr07.KanColleWrapper
{
	partial class KanColleProxy
	{
		...
		/// <summary>
		/// 追加：エンド ポイント "/kcsapi/api_get_member/misson" からのセッションを配信します。
		/// </summary>
		public IObservable<Session> api_get_member_mission
		{
			get { return this.ApiSessionSource.Where(x => x.Request.PathAndQuery == "/kcsapi/api_get_member/misson"); }
		}

		/// <summary>
		/// 追加：エンド ポイント "/kcsapi/api_get_member/set_friendly_request" からのセッションを配信します。
		/// </summary>
		public IObservable<Session> api_get_member_set_friendly_request
		{
